...
# ------------------------------------------------
VERSION = 'FasterRCNN_terra_05m_no_boost'
...
EPSILON = 1e-5
MOMENTUM = 0.9
LR = 5e-5 # 0.001  # 0.0003
DECAY_STEP = [50000, 70000]  # 50000, 70000
MAX_ITERATION = SAVE_WEIGHTS_INTE * 10

# -------------------------------------------- Data_preprocess_config
DATASET_NAME = 'sar_plane'  # 'ship', 'spacenet', 'pascal', 'coco'
...
ANCHOR_SCALES = [0.5, 1., 2.0, 2.5]  # [4, 8, 16, 32]
