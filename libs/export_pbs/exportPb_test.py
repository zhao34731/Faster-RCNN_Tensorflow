...
def pb_test(frozen_graph_path, test_dir):
...
if __name__ == '__main__':
    pb_test('/media/G/Develop/Faster-RCNN_Tensorflow-master/output/Pbs/FasterRCNN_Res101_sarplane_Frozen.pb',
         '/media/G/Develop/Faster-RCNN_Tensorflow-master/data/plane_back')
